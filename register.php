...
if ($_SESSION['droit_user']!="Admin") {
  ...
  if (isset($_POST['valider'])) {
      ...
      if ($mdp_user==$mdp_user_conf) {
        ...
        $insertion = $bdd->prepare("INSERT INTO user (nom_user,prenom_user,email_user,mdp_user,droit_user) VALUES(?,?,?,?,?)");
        $insertion->execute(array($nom_user,$prenom_user,$email_user,$mdp_user_hash,$droit_user));
                    ...
                    <div class="card shadow-sm my-5">
                      <div class="card-body p-0">
                         <div class="text-center bg-info">
                          <h1 class="h4 text-gray-900 mb-4">Création d'un utilisateur</h1>
                        </div>
                        <div class="row">
                          <div class="col-lg-12">
                            <div class="login-form">
                              <form method="POST">
                                <div class="form-group">
                                  <label>Nom</label>
                                  <input type="text" class="form-control" name="nom_user" value="<?php if(isset($nom_user)){ echo $nom_user;} ?>" id="exampleInputFirstName" placeholder="Entrer votre nom" required>
                                  <?php if (isset($messagde)) { ?>
                                      <span class="text-danger"><?php echo $message; ?></span>
                                    <?php } ?>
                                </div>
                                <div class="form-group">
                                  <label>Prénom</label>
                                  <input type="text" class="form-control" name="prenom_user" value="<?php if(isset($prenom_user)){ echo $prenom_user;} ?>" id="exampleInputLastName" placeholder="Entrer votre prénom" required>
                                  <?php if (isset($message)) { ?>
                                      <span class="text-danger"><?php echo $message; ?></span>
                                    <?php } ?>
                                </div>
                                <div class="form-group">
                                  <label>Email</label>
                                  <input type="email" class="form-control" name="email_user" value="<?php if(isset($email_user)){ echo $email_user;} ?>" id="exampleInputEmail" aria-describedby="emailHelp"
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                  ...
                                  <select class="form-control" name="droit_user" required>
                                    ...
                                    <?php } ?>
                                    <option>--Selectionner un droit utilisateur--</option>
