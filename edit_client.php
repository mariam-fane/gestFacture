  ...
  header('Location:login.php');
   ...
   require_once('db.php');
        ...
        if (isset($_POST['valider'])) {
              ...
              $update_client=$bdd->prepare("UPDATE Client SET 
                nomclt=:nomclt,
                prenomclt=:prenomclt,
                adresseclt=:adresseclt,
                contactclt=:contactclt,
                emailclt=:emailclt
                WHERE num_clt=:id");

              $update_client->bindValue(':id',$id);
              $update_client->bindValue(':nomclt',$nomclt);
              $update_client->bindValue(':prenomclt',$prenomclt);
              $update_client->bindValue(':contactclt',$contactclt);
              $update_client->bindValue(':emailclt',$emailclt);
              $update_client->bindValue(':adresseclt',$adresseclt);
                                 ...
                                 <div class="row">
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                          <label for="">Nom</label>
                                          <input type="text" name="nomclt" value="<?= $clt['nomclt']?>" placeholder="Nom" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                          <label for="">Prénom </label>
                                          <input type="text" class="form-control" value="<?= $clt['prenomclt']?>" placeholder="Prénom" name="prenomclt" value="" id="" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                          <label for="">Téléphone </label>
                                          <input type="number" class="form-control" value="<?= $clt['contactclt']?>" placeholder="Téléphone (Facultatife)" name="contactclt" value="" id="" required>
                                        </div>
                                    </div>
                                     <div class="col-lg-3">
                                        <div class="form-group">
                                          <label for="">Email </label>
                                          <input type="email" class="form-control" value="<?= $clt['emailclt']?>" placeholder="Email (Facultatife)" name="emailclt" value="" id="" required>
                                        </div>
                                    </div>
                                  </div>
                                <div class="row">
                                  <div class="col-12">
                                    <div class="form-group">
                                      ...
                                      <textarea class="form-control" name="adresseclt" placeholder="Addresse (Facultatife)"><?= $clt['adresseclt'] ?></textarea>
                                    </div>
                                  </div>
                                </div>
                              </div>
