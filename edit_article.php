  ...
  header('Location:login.php');
   ...
   require_once('db.php');
            ...
            if (isset($_GET['refProduit'])) {
               $id = $_GET['refProduit'];
               $article = $bdd->prepare("SELECT * FROM produit WHERE refProduit=?");
        ...
        if (isset($_POST['valider'])) {
              ...
              $update_article=$bdd->prepare("UPDATE produit SET 
                designation=:designation,
                prix_intial=:prix_intial
                WHERE refProduit=:id");

              $update_article->bindValue(':id',$id);
              $update_article->bindValue(':designation',$designation);
              $update_article->bindValue(':prix_intial',$prix);
              ...
              if ($update_article==true) {
                  $message="L'article a été modifiée avec succès";
              }
                        ...
                        <div class="col-lg-12">
                            <div class="card mb-4">
                              <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">Modification d'un article</h6>
                              </div>
                                 ...
                                 <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                          ...
                                          <input type="text" name="designation" value="<?= $art['designation']?>" placeholder="Désignation" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                          <label for="">Prix </label>
                                          <input type="number" class="form-control" value="<?= $art['prix_intial']?>" placeholder="Prix" name="prix" value="" id="" required>
                                        </div>
                                    </div>
                                  </div>
